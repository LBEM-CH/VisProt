...
SavedClasses = vp.fm.natsortfiles(SavedClasses);
...
DDerror = vp.fm.bootstrapdata(SavedClasses, nbrSavedClasses, nbrdatasets, rawfolder, lastfile, nbrfiles);
...
[xname_sum_order(:,1) index] = vp.fm.natsortfiles(xname_sum(:,1));
