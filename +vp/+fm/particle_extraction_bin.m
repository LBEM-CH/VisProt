function [numberOfBlobs_inBorder, coordinate] = particle_extraction_bin(ob, ob_VisProt, datasetid)
% Extracts MATLAB-detected particles to .MRC files for Negative-staining EM data
