classdef VisProtGui_Linux < handle
    ...
    methods
        function obj  = VisProtGui_Linux % Gui initialization
            ...
            textSData = uicontrol(panData,'Style','text','String','Micrograph selection','Units','Normalized','Position',[.09 .53 .3 .35]);
            ...
            obj.ac = '0.1';
            obj.px = '1.000';
            textSMinpick = uicontrol(panPick,'Style','text','String','Min diameter (A)','Units','Normalized','Position',[.1 .675 .31 .15]);
            textEMinpick = uicontrol(panPick,'Style','edit','String',obj.min,'Units','Normalized','Position',[.45 .765 .3 .06],'Tag','eMinpick');
 
            textSMaxpick = uicontrol(panPick,'Style','text','String','Max diameter (A)','Units','Normalized','Position',[.1 .565 .31 .15]);
            ...
            bOkPick = uicontrol(panPick,'Style','pushbutton','String','Start picking','Units','Normalized','Position',[.33 .105 .35 .08],'Callback',{@OkPick_Callback});
            ...
            bViewPick = uicontrol(panPick,'Style','pushbutton','String','View picking results','Units','Normalized','Position',[.275 .015 .45 .08],'Callback',{@ViewPick_Callback});
    ...
    %                     exe_path = exe_path{2};
                ...
                for datasetID = 1:obj.NumberDatasets
                    while ~exist(['RawMicrographs/',obj.RawFolder(datasetID).name,'/',obj.last_file{datasetID}{obj.ParprocessClass.NumberFiles},'_automatchAll.star'])
                        pause(1);
                    end
                end
