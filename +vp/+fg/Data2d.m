classdef Data2d
    ...
    methods
        function obj = Data2d(nbrDatasets, rawfolder, last_file, nbrFiles)
            % Get data
            [obj.Datanorm, obj.Dataerrornorm, obj.Xname, obj.NumberSavedClasses] = vp.fg.getdata(nbrDatasets, rawfolder, last_file, nbrFiles);
            % PCA for selecting significant classes
            [obj.Sel, obj.Datanorm_sel, obj.Dataerrornorm_sel, obj.Selected_Averages] = vp.fg.pcasel(obj.Datanorm, obj.Dataerrornorm, obj.Xname);
        end
